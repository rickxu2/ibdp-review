...
- `attempts/YYYY-MM.json` — 逐题记录数组（原子单位，schema 见 mark skill）
...
## 网站
- 本地全功能版：运行 `scripts/serve.ps1` → http://localhost:8788/docs/ （课本跳转按钮直达 PDF 页）
- 公网版（Pages）：数据可视化完整可用，PDF 跳转降级为"书名+页码"文字。
